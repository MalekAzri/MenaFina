        ...
        <section id="features-section" className="py-20 bg-dark-secondary">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div id="features-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <Link href="/login" className="block bg-dark-primary rounded-xl p-8 border border-dark-border hover:border-blue-500/50 transition-all duration-300 group cursor-pointer hover:shadow-lg hover:shadow-blue-500/10">
                    ...
                    <Link href="/login" className="block bg-dark-primary rounded-xl p-8 border border-dark-border hover:border-purple-500/50 transition-all duration-300 group cursor-pointer hover:shadow-lg hover:shadow-purple-500/10">
                    ...
                    <Link href="/login" className="block bg-dark-primary rounded-xl p-8 border border-dark-border hover:border-green-500/50 transition-all duration-300 group cursor-pointer hover:shadow-lg hover:shadow-green-500/10">
